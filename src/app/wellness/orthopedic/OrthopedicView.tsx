                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-6">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <span className="text-[10px] font-black uppercase tracking-widest text-royal-blue/40">Near accredited hospitals</span>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="relative h-[600px] w-full rounded-[3rem] overflow-hidden shadow-2xl bg-royal-blue/5">
                                    ...
                                    <div className="absolute inset-0 flex items-center justify-center p-12">
                                        <div className="text-center">
                                            ...
                                            <h5 className="text-2xl font-black text-royal-blue uppercase tracking-tighter mb-4">RECOVERY, ORCHESTRATED</h5>
                                            <p className="text-[10px] font-black uppercase tracking-[0.5em] text-royal-blue/40">Logistics You Can Trust</p>
                                        </div>
                                    </div>
                                </div>
                            </Tilt3D>
                ...
                <section className="py-20 bg-royal-blue relative overflow-hidden">
                    <div className="container mx-auto px-6 relative z-10">
                        <div className="flex flex-col md:flex-row justify-between items-end gap-12 mb-20">
                            <div>
                                <h4 className="text-sunset-orange font-black uppercase tracking-[0.8em] text-xs mb-6">Where We Base You</h4>
                                <h2 className="text-5xl md:text-8xl font-black text-white uppercase tracking-tighter leading-none">PRIMARY GATEWAYS</h2>
                            </div>
