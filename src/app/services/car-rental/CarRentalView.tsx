            ...
            <section className="py-40 container mx-auto px-6 relative z-10">
                <div className="flex flex-col md:flex-row items-end justify-between mb-32 gap-12 text-center md:text-left">
                    ...
                    >
                        ...
                        <span className="text-xs font-black uppercase tracking-[0.4em] text-royal-blue max-w-[240px] leading-relaxed">Every rental is a GPS-tracked vehicle with a vetted, professional chauffeur.</span>
                    </motion.div>
                </div>
