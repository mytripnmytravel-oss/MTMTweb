...
export default function Home() {
  ...
  const packages = [
    ...
    { id: 3, city: "Lakes & Romance", title: "Udaipur Extension", desc: "The Venice of the East meets the Golden Triangle. Sunset boat rides and palace dining.", duration: "9 Days", theme: "Heritage", img: "https://images.unsplash.com/photo-1590393533632-6858220f8646?q=80&w=2574&auto=format&fit=crop", size: "md:col-span-1 md:row-span-1" },
