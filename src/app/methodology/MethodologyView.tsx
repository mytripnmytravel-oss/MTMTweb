...
const StatItem = ({ label, value, desc }: { label: string; value: string; desc: string }) => (
    <div className="glass-card p-8 border-royal-blue/5 hover:border-sunset-orange/20 transition-all group">
        <div className="text-sunset-orange font-semibold text-3xl mb-2 tracking-tight uppercase">{value}</div>
        <div className="text-royal-blue font-semibold uppercase tracking-widest text-xs mb-4">{label}</div>
...
const ProtocolBlock = ({ step, title, desc, icon: Icon, features }: { step: string; title: string; desc: string; icon: any; features: string[] }) => (
    <div className="relative pl-12 pb-20 border-l border-royal-blue/10 last:pb-0">
        ...
        <div className="absolute left-[-60px] top-4 text-[10px] font-semibold text-royal-blue/20 rotate-[-90deg] uppercase tracking-widest">Phase {step}</div>

        <h3 className="text-3xl md:text-5xl font-semibold text-royal-blue uppercase tracking-tight mb-6">{title}</h3>
        ...
        <div className="grid sm:grid-cols-2 gap-6 max-w-2xl">
            {features.map((feature, i) => (
                <div key={i} className="flex items-center gap-4 bg-white p-4 rounded-xl border border-royal-blue/5 shadow-sm">
                    ...
                    <span className="text-[10px] font-semibold text-royal-blue uppercase tracking-widest">{feature}</span>
                </div>
            ))}
        </div>
    </div>
        ...
        <div className="min-h-screen bg-soft-white selection:bg-sunset-orange selection:text-white font-sans overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="max-w-4xl">
                        ...
                        >
                            ...
                            <span className="text-white font-semibold uppercase tracking-[0.4em] text-[10px]">Mission Protocol briefing.v04</span>
                        </motion.div>

                        <CharBlurIn
                            text="THE"
                            className="text-6xl md:text-[8rem] font-semibold text-white leading-none tracking-tight uppercase mb-2"
                        />
                        <CharBlurIn
                            text="METHODOLOGY"
                            className="text-6xl md:text-[8rem] font-semibold text-white leading-none tracking-tight uppercase drop-shadow-[0_10px_30px_rgba(249,115,22,0.3)]"
                        />
                    ...
                    <div className="flex flex-col lg:flex-row gap-20">
                        ...
                        <div className="lg:w-1/3">
                            <div className="sticky top-40">
                                <h4 className="text-royal-blue font-semibold uppercase tracking-[0.8em] text-xs mb-6">Master Protocol</h4>
                                <h2 className="text-5xl font-semibold text-royal-blue leading-none tracking-tight uppercase mb-8">The Full <br /> Dossier.</h2>
                                ...
                                <div className="mt-12 space-y-4">
                                    {['01 Curation', '02 Activation', '03 Execution', '04 Retention'].map((p) => (
                                        <div key={p} className="flex items-center gap-4 text-royal-blue/20 font-semibold uppercase tracking-widest text-[10px]">
            ...
            <section className="py-32 bg-royal-blue relative z-20 overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="text-center mb-24">
                        <h4 className="text-sunset-orange font-semibold uppercase tracking-[0.8em] text-sm mb-4">Directives</h4>
                        <h2 className="text-5xl md:text-7xl font-semibold text-white uppercase tracking-tight">THE CORE VALUES</h2>
                    </div>

                    <div className="grid md:grid-cols-3 gap-12">
                        <div className="bg-white/5 border border-white/10 p-12 rounded-2xl text-center group hover:bg-white/10 transition-all">
                            <Shield className="text-sunset-orange mx-auto mb-8" size={48} />
                            <h3 className="text-2xl font-semibold text-white uppercase tracking-tight mb-4">UNCOMPROMISING SAFETY</h3>
                            <p className="text-white/60 text-sm leading-relaxed">Every vehicle is checked and prepared before it reaches you. No exceptions.</p>
                        </div>
                        <div className="bg-white/5 border border-white/10 p-12 rounded-2xl text-center group hover:bg-white/10 transition-all">
                            <Activity className="text-sunset-orange mx-auto mb-8" size={48} />
                            <h3 className="text-2xl font-semibold text-white uppercase tracking-tight mb-4">REAL-TIME AGILITY</h3>
                        ...
                        <div className="bg-white/5 border border-white/10 p-12 rounded-2xl text-center group hover:bg-white/10 transition-all">
                            ...
                            <h3 className="text-2xl font-semibold text-white uppercase tracking-tight mb-4">ABSOLUTE PRECISION</h3>
            ...
            <section className="py-20 md:py-40 bg-white relative z-20">
                <div className="container mx-auto px-6 text-center">
                    <h2 className="text-4xl md:text-[6rem] font-semibold text-royal-blue uppercase tracking-tight leading-none mb-12">
