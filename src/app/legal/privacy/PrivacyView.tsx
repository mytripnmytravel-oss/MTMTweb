            ...
            <main className="bg-white min-h-screen relative overflow-hidden">
                ...
                <section className="pt-60 pb-32 container mx-auto px-6 relative z-10 max-w-4xl">
                    ...
                    <div className="space-y-12 text-dark-slate/80 font-medium leading-relaxed">
                        <div>
                            <h2 className="text-2xl font-black text-royal-blue uppercase tracking-tighter mb-4">1. Information we collect</h2>
                        ...
                        <div>
                            <h2 className="text-2xl font-black text-royal-blue uppercase tracking-tighter mb-4">2. How we use your information</h2>
                        ...
                        <div>
                            <h2 className="text-2xl font-black text-royal-blue uppercase tracking-tighter mb-4">3. Sharing with third parties</h2>
                        ...
                        <div>
                            <h2 className="text-2xl font-black text-royal-blue uppercase tracking-tighter mb-4">4. Data security</h2>
                        ...
                        <div>
                            <h2 className="text-2xl font-black text-royal-blue uppercase tracking-tighter mb-4">5. Your rights</h2>
                        ...
                        <div>
                            <h2 className="text-2xl font-black text-royal-blue uppercase tracking-tighter mb-4">6. Contact us</h2>
