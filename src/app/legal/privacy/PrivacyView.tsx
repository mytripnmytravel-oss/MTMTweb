    ...
    return (
        <main className="min-h-screen bg-paper">
            ...
            <section className="container-narrow pt-36 pb-20 sm:pt-40 sm:pb-28">
                ...
                <h1 className="display-1 font-medium text-ink mt-5">Privacy Policy</h1>
                ...
                <div className="mt-12 space-y-10 text-ink-soft">
                    ...
                    <div>
                        <h2 className="text-xl font-medium text-ink">3. Sharing with third parties</h2>
                    ...
                    <div>
                        <h2 className="text-xl font-medium text-ink">4. Data security</h2>
                    ...
                    <div>
                        <h2 className="text-xl font-medium text-ink">5. Your rights</h2>
                    ...
                    <div>
                        <h2 className="text-xl font-medium text-ink">6. Contact us</h2>
