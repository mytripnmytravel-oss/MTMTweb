    ...
    return (
        <main className="min-h-screen bg-paper">
            ...
            <section className="container-narrow pt-36 pb-20 sm:pt-40 sm:pb-28">
                ...
                <h1 className="display-1 font-medium text-ink mt-5">Terms of Service</h1>

                <div className="mt-12 space-y-10 text-ink-soft">
                    <div>
                        <h2 className="text-xl font-medium text-ink">1. About these terms</h2>
                    ...
                    <div>
                        <h2 className="text-xl font-medium text-ink">2. Bookings and payments</h2>
                    ...
                    <div>
                        <h2 className="text-xl font-medium text-ink">3. Changes and cancellations</h2>
                    ...
                    <div>
                        <h2 className="text-xl font-medium text-ink">4. Our responsibilities and liability</h2>
                    ...
                    <div>
                        <h2 className="text-xl font-medium text-ink">5. Contact us</h2>
