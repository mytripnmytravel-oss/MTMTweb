            ...
            <main className="bg-white min-h-screen relative overflow-hidden">
                ...
                <section className="pt-60 pb-32 container mx-auto px-6 relative z-10 max-w-4xl">
                    ...
                    <div className="space-y-12 text-dark-slate/80 font-medium leading-relaxed">
                        <div>
                            <h2 className="text-2xl font-black text-royal-blue uppercase tracking-tighter mb-4">1. About these terms</h2>
                        ...
                        <div>
                            <h2 className="text-2xl font-black text-royal-blue uppercase tracking-tighter mb-4">2. Bookings and payments</h2>
                        ...
                        <div>
                            <h2 className="text-2xl font-black text-royal-blue uppercase tracking-tighter mb-4">3. Changes and cancellations</h2>
                        ...
                        <div>
                            <h2 className="text-2xl font-black text-royal-blue uppercase tracking-tighter mb-4">4. Our responsibilities and liability</h2>
                        ...
                        <div>
                            <h2 className="text-2xl font-black text-royal-blue uppercase tracking-tighter mb-4">5. Contact us</h2>
