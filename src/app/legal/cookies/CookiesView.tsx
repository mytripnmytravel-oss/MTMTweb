    ...
    return (
        <main className="min-h-screen bg-paper">
            ...
            <section className="container-narrow pt-36 pb-20 sm:pt-40 sm:pb-28">
                ...
                <h1 className="display-1 font-medium text-ink mt-5">Cookie Policy</h1>

                <div className="mt-12 space-y-10 text-ink-soft">
                    <div>
                        <h2 className="text-xl font-medium text-ink">1. What cookies we use</h2>
                    ...
                    <div>
                        <h2 className="text-xl font-medium text-ink">2. Analytics</h2>
                    ...
                    <div>
                        <h2 className="text-xl font-medium text-ink">3. Managing cookies</h2>
                    ...
                    <div>
                        <h2 className="text-xl font-medium text-ink">4. Contact us</h2>
