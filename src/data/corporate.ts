// Corporate cluster (grid F2 to F3). Categorical sub-layers beneath the
...
export const corporateCategories: CorporateCategory[] = [
    {
        ...
        items: [
            ...
            {
                slug: "mid-team",
                name: "Mid Team (15 to 50)",
                answer:
                    "A mid-size corporate trip of 15 to 50 is run as a small GPS-tracked convoy with coordinated room blocks and choreographed event flow across the wedding-style sequence of arrivals, sessions, offsite activity, and dining. MyTripMyTravel manages the ground layer so the organiser owns the agenda, not the logistics.",
                intro: [
                ...
                faqs: [
                    { q: "What about a 30-person company offsite?", a: "A 15 to 50 mission uses a small GPS-tracked convoy with room-block coordination and choreographed session-to-offsite-to-dining flow, run with a named on-ground coordinator and single-point accountability." },
            ...
            {
                slug: "large-team",
                name: "Large Team (50 to 200)",
                answer:
                    "A large corporate mission of 50 to 200 is a full managed operation: multi-property accommodation, a large GPS-tracked convoy, dedicated on-ground command, staged movement, and documented contingency. MyTripMyTravel runs it as a logistics-led mission where movement, timing, and fallback are the deliverable.",
                intro: [
                ...
                faqs: [
                    { q: "Can you run a 150-person corporate trip?", a: "Yes, large missions (50 to 200) are full managed operations with a large convoy, dedicated on-ground command, multi-property block management, and wave-sequenced movement." },
