...
export function getLocationContent(
    ...
    return {
        ...
        points: [
            ...
            { label: "Recommended length", detail: programme.slug === "ayurvedic" ? "14+ days for classical Panchakarma; 7–10 for substantive Ayurveda; 3–5 for an introduction within a broader Kerala trip." : programme.slug === "yoga-soul" ? "7–14 days for a real practice arc; 3–5 for a foundational introduction." : "Programme-dependent — recommended at booking based on your needs." },
        ],
        faqs: [
            ...
            { q: `How long should I stay for ${programme.name} in ${location.name}?`, a: programme.slug === "ayurvedic" ? "For classical Panchakarma, 14 days minimum (commonly 21–28). For a shorter Ayurvedic restoration, 7–10 days is meaningful. 3–5 days is an introduction within a broader trip." : "Programme-dependent. The planning desk recommends a length based on your goals and the discipline's real requirements rather than the calendar." },
