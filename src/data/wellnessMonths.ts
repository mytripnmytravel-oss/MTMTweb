// Wellness × month engine (grid D5). Per-programme monthly framing —
// every programme has 12 honest month pages. The framing is anchored
...
function framing(programmeSlug: string, month: WellnessMonth): MonthFraming {
    ...
    if (programmeSlug === "ayurvedic") {
        ...
        // (June–August, leaning July) are the classical treatment window.
        ...
        if (isMonsoonTail) {
            return {
                ...
                points: [
                    ...
                    { label: "Length recommendation", detail: "7–14 days. Enter ${m} and exit into the clear October window.".replace("${m}", m) },
                ],
            };
        }
        if (isPeak) {
            return {
                ...
                points: [
                    ...
                    { label: "Length recommendation", detail: "5–14 days. Combinable with backwater and beach legs without weather risk." },
                ],
            };
        }
        if (isShoulder) {
            return {
                ...
                points: [
                    ...
                    { label: "Length recommendation", detail: "5–10 days." },
                ],
            };
        }
        // Apr/May
        return {
            ...
            points: [
                ...
                { label: "Length recommendation", detail: "5–10 days, programme-anchored." },
            ],
        };
    }
    ...
    if (programmeSlug === "yoga-soul") {
        ...
        if (isClarity) {
            return {
                ...
                points: [
                    ...
                    { label: "Length recommendation", detail: "7–14 days for the right practice arc." },
                ],
            };
        }
        if (isWinter) {
            return {
                ...
                points: [
                    ...
                    { label: "Length recommendation", detail: "7–14 days; the slower ramp benefits from a longer stay." },
                ],
            };
        }
        if (isSpring) {
            return {
                ...
                points: [
                    ...
                    { label: "Length recommendation", detail: "5–14 days." },
                ],
            };
        }
        if (isHotPreMonsoon) {
        ...
        return {
            ...
            points: [
                ...
                { label: "Length recommendation", detail: "7–14 days — longer stays absorb the weather flex better." },
            ],
        };
    }
        ...
        if (isPeak) {
            return {
                ...
                points: [
                    ...
                    { label: "Length recommendation", detail: "7–14 days per the procedure and surgeon's protocol." },
                ],
            };
        }
        if (isShoulder) {
            return {
                ...
                points: [
                    ...
                    { label: "Length recommendation", detail: "7–14 days." },
                ],
            };
        }
        if (isHot) {
            return {
                ...
                points: [
                    ...
                    { label: "Length recommendation", detail: "7–14 days per the surgeon's protocol." },
                ],
            };
        }
        // Monsoon
    ...
    if (isHot) {
        return {
            ...
            points: [
                ...
                { label: "Length recommendation", detail: "5–7 days." },
            ],
        };
    }
    // Monsoon
