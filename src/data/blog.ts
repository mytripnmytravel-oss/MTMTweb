...
export const blogPosts: BlogPost[] = [
    {
        ...
        faqs: [
            { q: "Is the Golden Triangle worth doing as a first India trip?", a: "Yes, it covers more architectural and historical ground per kilometre than any other circuit in the country, and the logistics are mature. Done in 5 to 7 days with a private chauffeured operator, it is the highest-density introduction to North India." },
    ...
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                paragraphs: [
                    ...
                    "Ladakh (Leh) is essentially a May-to-September destination. Outside that window the high passes close, the Manali to Leh and Srinagar to Leh roads seal, and only specialist winter itineraries operate. The first 24 to 36 hours in Leh must be a rest-and-acclimatise buffer regardless of season.",
            ...
            },
            {
                ...
                paragraphs: [
                    ...
                    "There is an exception: the monsoon is the traditional Karkidaka Ayurveda treatment season. Serious wellness travellers deliberately choose July to August Kerala specifically for the rains.",
                ],
            },
            {
                heading: "The Andamans",
                paragraphs: [
                    "The Andamans run on their own calendar. October to May is the reliable window: calm seas, strong ferry frequency, excellent dive visibility. December to April is peak. The southwest monsoon (June to September) brings rough seas that disrupt inter-island transfers and water activities; we generally do not run Andaman missions in that window.",
                ],
            },
            {
        ...
        faqs: [
            ...
            { q: "Can I visit Ladakh in winter?", a: "Specialist winter itineraries operate (frozen-river treks, monastic stays), but the standard travel season is May to September. The first 24 to 36 hours in Leh must be a rest buffer regardless of season." },
        ],
        related: [
    ...
    },
    {
        ...
        sections: [
            {
                ...
                paragraphs: [
                    ...
                    "Six months is the practical floor for a classic 50 to 150 guest wedding at a strong venue. Larger productions or marquee venue buyouts are commonly committed twelve to eighteen months ahead. Smaller, intimate weddings at havelis can compress to three or four months when the dates are flexible.",
                ],
            },
            {
            ...
            },
            {
                ...
                paragraphs: [
                    "An intimate wedding under 50 guests is not a scaled-down large wedding; it is a different product, optimised for closeness and craft. A classic 50 to 150 is the most common band, with full multi-event choreography at a single property. A grand 150 to 400 is full convoy and multi-property operation; a royal 400+ is venue buyouts and encrypted logistics sync, run as a production with dedicated event command.",
                ],
            },
            {
        ...
        faqs: [
            { q: "How far in advance should I plan a destination wedding in India?", a: "Six months minimum for a classic 50 to 150 guest wedding at a strong venue; 12 to 18 months for large productions or marquee venue buyouts; 3 to 4 months can work for intimate havelis with flexible dates." },
    ...
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                paragraphs: [
                    ...
                    "Timing. April to June is hot but is the highest-sighting window because animals concentrate at water. October to April is the comfort-and-cover compromise. The park closes its core zones during the monsoon (July to September).",
                ],
            },
            {
        ...
        faqs: [
            ...
            { q: "When is the park closed?", a: "Core zones close during the monsoon, roughly July through September. The reserve is best October to April for comfort, with April to June being the highest-sighting window but the hottest." },
    ...
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                paragraphs: [
                    ...
                    "Second, the programme has a meaningful length. Authentic Panchakarma (the classical five-action purification) runs a minimum of around 14 days and more commonly 21 to 28. Rasayana rejuvenation runs 14 to 28. A '3-day Panchakarma' is a spa adaptation; the real therapy does not fit in three days.",
        ...
        faqs: [
            ...
            { q: "How long does authentic Panchakarma take?", a: "A minimum of around 14 days, more commonly 21 to 28. Shorter offerings labelled 'Panchakarma' are spa adaptations of the term." },
    ...
    },
    {
        ...
        sections: [
            {
                ...
                paragraphs: [
                    "The Golden Triangle is dense. In 5 to 7 days it covers more iconic architecture, the Taj Mahal, Agra Fort, Fatehpur Sikri, the Red Fort and Humayun's Tomb in Delhi, Amer Fort and the Jaipur palaces, than most circuits anywhere in the world deliver in the same window.",
            ...
            },
            {
                ...
                paragraphs: [
                    "First India trip with 5 to 7 days. The priority is the iconic experience, a sunrise Taj, the Red Fort, Amer Fort, and a sense of the country's range. A 5-day Golden Triangle plus an arrival night and a departure day is a complete trip.",
            ...
            },
            {
                ...
                paragraphs: [
                    ...
                    "10 to 14 days with a preference for fewer cities, more time per city. Rajasthan rewards that pacing; the Triangle compressed into the same time becomes a tour-bus pace at half-day intervals.",
                ],
            },
            {
                heading: "How to combine them in one trip",
                paragraphs: [
                    "A 10 to 14 day mission can comfortably hold the Triangle plus Udaipur and Jodhpur. The route runs Delhi → Agra → Jaipur (Triangle core), then onward to Pushkar, Jodhpur, and Udaipur, with the option of a Ranthambore wildlife leg from Jaipur en route to Jodhpur.",
        ...
        faqs: [
            { q: "Is the Golden Triangle enough for a first India trip?", a: "Often yes, 5 to 7 days of Delhi, Agra, and Jaipur covers more iconic ground per kilometre than any other route, and arrival fatigue is real. Save Rajasthan for a second trip, or combine in 10 to 14 days." },
            { q: "How long for full Rajasthan?", a: "10 to 14 days for the marquee circuit (Udaipur, Jodhpur, Jaisalmer with Pushkar and either Ranthambore or Bundi). The Triangle plus full Rajasthan fits in 14 days; less and depth thins." },
