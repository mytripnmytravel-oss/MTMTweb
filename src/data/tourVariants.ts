...
export const ORIGINS: Origin[] = [
    { slug: "new-york", city: "New York", country: "USA", flightBand: "~14 to 15 hrs (non-stop) to Delhi", note: "Most US e-Visa-eligible travellers arrive at Delhi (DEL) and begin the circuit after a recovery night." },
    { slug: "los-angeles", city: "Los Angeles", country: "USA", flightBand: "~16 to 18 hrs (one-stop) to Delhi", note: "A West Coast arrival usually routes one-stop; we build a generous first-day buffer for the long crossing." },
    { slug: "san-francisco", city: "San Francisco", country: "USA", flightBand: "~15 to 17 hrs to Delhi", note: "Non-stop and one-stop options exist; the itinerary absorbs jet lag before the first monument." },
    { slug: "chicago", city: "Chicago", country: "USA", flightBand: "~14 to 16 hrs to Delhi", note: "Typically one-stop via a European or Gulf hub into Delhi (DEL)." },
    { slug: "toronto", city: "Toronto", country: "Canada", flightBand: "~14 to 15 hrs (non-stop) to Delhi", note: "Non-stop service into Delhi makes Toronto one of the smoother North American origins." },
    { slug: "london", city: "London", country: "UK", flightBand: "~8.5 to 9 hrs (non-stop) to Delhi", note: "One of the easiest origins, frequent non-stops into Delhi (DEL) and a manageable time shift." },
    { slug: "manchester", city: "Manchester", country: "UK", flightBand: "~9 to 11 hrs to Delhi", note: "Direct and one-stop options; the circuit starts after a single arrival night." },
    { slug: "paris", city: "Paris", country: "France", flightBand: "~8.5 to 9.5 hrs (non-stop) to Delhi", note: "Frequent non-stops into Delhi; a comfortable European origin for the Golden Triangle." },
    { slug: "frankfurt", city: "Frankfurt", country: "Germany", flightBand: "~7.5 to 8.5 hrs (non-stop) to Delhi", note: "A major hub with strong non-stop frequency into Delhi (DEL)." },
    ...
    { slug: "abu-dhabi", city: "Abu Dhabi", country: "UAE", flightBand: "~3.5 to 4 hrs (non-stop) to Delhi", note: "Very short crossing; the circuit can start the same day with a fresh arrival." },
    ...
    { slug: "singapore", city: "Singapore", country: "Singapore", flightBand: "~5.5 to 6 hrs (non-stop) to Delhi", note: "An easy Asia-Pacific origin with minimal time shift and frequent non-stops." },
    { slug: "sydney", city: "Sydney", country: "Australia", flightBand: "~13 to 16 hrs (one-stop) to Delhi", note: "Usually one-stop via a Gulf or Asian hub; we build in a firm recovery buffer." },
    { slug: "tokyo", city: "Tokyo", country: "Japan", flightBand: "~9 to 12 hrs to Delhi", note: "Non-stop and one-stop options; a strong Phase-2 market with a manageable shift." },
    ...
    // North America
    { slug: "boston", city: "Boston", country: "USA", flightBand: "~13.5 to 14.5 hrs (non-stop) to Delhi", note: "Non-stop service into Delhi (DEL); East Coast travellers usually take a recovery night before the circuit." },
    { slug: "washington-dc", city: "Washington DC", country: "USA", flightBand: "~14 to 15 hrs (non-stop) to Delhi", note: "Non-stop into Delhi (DEL); we build a recovery buffer for the long crossing." },
    { slug: "houston", city: "Houston", country: "USA", flightBand: "~16 to 17 hrs (one-stop) to Delhi", note: "Typically one-stop via a European or Gulf hub into Delhi (DEL), with a generous arrival buffer." },
    { slug: "dallas", city: "Dallas", country: "USA", flightBand: "~16 to 17 hrs (one-stop) to Delhi", note: "Usually one-stop into Delhi (DEL); the first day absorbs the long crossing." },
    { slug: "atlanta", city: "Atlanta", country: "USA", flightBand: "~16 to 18 hrs (one-stop) to Delhi", note: "One-stop via a European or Gulf hub into Delhi (DEL)." },
    { slug: "seattle", city: "Seattle", country: "USA", flightBand: "~15 to 17 hrs (one-stop) to Delhi", note: "A West Coast arrival routes one-stop; a firm recovery buffer is built in." },
    { slug: "vancouver", city: "Vancouver", country: "Canada", flightBand: "~15 to 17 hrs (one-stop) to Delhi", note: "One-stop via an Asian or European hub into Delhi (DEL)." },
    { slug: "montreal", city: "Montreal", country: "Canada", flightBand: "~14 to 15 hrs (one-stop) to Delhi", note: "One-stop into Delhi (DEL); the circuit begins after an arrival night." },
    // Europe
    { slug: "rome", city: "Rome", country: "Italy", flightBand: "~8.5 to 9 hrs (non-stop) to Delhi", note: "Non-stop service into Delhi (DEL); a comfortable European origin." },
    { slug: "madrid", city: "Madrid", country: "Spain", flightBand: "~9 to 10 hrs (non-stop/one-stop) to Delhi", note: "Direct and one-stop options into Delhi (DEL)." },
    ...
    { slug: "dublin", city: "Dublin", country: "Ireland", flightBand: "~9 to 10 hrs (one-stop) to Delhi", note: "Usually one-stop into Delhi (DEL); an arrival night settles the shift." },
    ...
    { slug: "muscat", city: "Muscat", country: "Oman", flightBand: "~2.5 to 3 hrs (non-stop) to Delhi", note: "A very short hop into Delhi (DEL); the circuit starts the same day." },
    { slug: "bahrain", city: "Bahrain", country: "Bahrain", flightBand: "~4 hrs (non-stop) to Delhi", note: "A short Gulf crossing into Delhi (DEL)." },
    { slug: "tel-aviv", city: "Tel Aviv", country: "Israel", flightBand: "~5.5 to 6 hrs (non-stop) to Delhi", note: "A short crossing into Delhi (DEL) with a manageable shift." },
    // Asia-Pacific
    ...
    { slug: "jakarta", city: "Jakarta", country: "Indonesia", flightBand: "~7 to 8 hrs (one-stop) to Delhi", note: "Usually one-stop via an Asian hub into Delhi (DEL)." },
    { slug: "seoul", city: "Seoul", country: "South Korea", flightBand: "~8 to 9 hrs (non-stop) to Delhi", note: "Non-stop and one-stop options into Delhi (DEL)." },
    ...
    { slug: "beijing", city: "Beijing", country: "China", flightBand: "~7.5 to 8 hrs (non-stop) to Delhi", note: "Non-stop service into Delhi (DEL)." },
    { slug: "melbourne", city: "Melbourne", country: "Australia", flightBand: "~13 to 16 hrs (one-stop) to Delhi", note: "One-stop via a Gulf or Asian hub into Delhi (DEL); a firm recovery buffer is built in." },
    // Africa
    { slug: "johannesburg", city: "Johannesburg", country: "South Africa", flightBand: "~9 to 10 hrs (non-stop) to Delhi", note: "Non-stop service into Delhi (DEL)." },
...
export function resolveVariant(
    ...
    if (dimension === "theme-month") {
        ...
        return {
            ...
            intro: `${n.intro} For the ${theme.toLowerCase()} reading specifically, the pacing, stays, dining, and access slots are reweighted to a ${theme.toLowerCase()} register. The Delhi to Agra to Jaipur core is preserved; what changes is the priority on each leg, refined to your party during planning.`,
            packages: list,
            faqs: [
    ...
    if (dimension === "theme-from") {
        ...
        return {
            ...
            answer: `A ${theme.toLowerCase()} Golden Triangle tour from ${origin.city}, ${origin.country} with MyTripMyTravel is a private, chauffeured Delhi to Agra to Jaipur circuit reweighted to a ${theme.toLowerCase()} register, beginning at Delhi (DEL). ${travelContextLabel(origin)}: ${origin.flightBand}. ${origin.note} ${list.length} ${theme.toLowerCase()} architecture${list.length > 1 ? "s are" : " is"} available, from ${list[0].price}, each escorted, ${pacingAdj(origin)}, and fully customisable.`,
            intro: `The intersection of a ${theme.toLowerCase()} reading of the Golden Triangle with a ${origin.city} departure is both a routing and an experience decision. ${origin.note} The first day is sequenced around the ${firstDayClause(origin)}, with the ${theme.toLowerCase()} register held from the welcome onward. The Delhi to Agra to Jaipur core is preserved; what changes is the weighting, the pace, the stays, the dining, and the access slots tuned to a ${theme.toLowerCase()} emphasis. Every architecture below is a starting frame, customisable while holding the ${theme.toLowerCase()} character and adjusted to your arrival window from ${origin.city}.`,
            packages: list,
            faqs: [
                getThereFaq(origin),
                { q: `What makes a ${theme} Golden Triangle from ${origin.city} different?`, a: `The route core stays Delhi to Agra to Jaipur, but the pacing, stays, dining, and inclusions are reweighted toward a ${theme.toLowerCase()} experience. The ${origin.city} arrival window, ${origin.flightBand}, drives the first-day sequencing.` },
                visaOrTravelFaq(origin),
    ...
    if (dimension === "from-origin") {
        ...
        return {
            ...
            answer: `A Golden Triangle tour from ${origin.city}, ${origin.country} with MyTripMyTravel is a private, chauffeured Delhi to Agra to Jaipur circuit beginning at Delhi (DEL), the arrival gateway. ${travelContextLabel(origin)}: ${origin.flightBand}. ${origin.note} ${list.length} mission architectures are available, each escorted, ${pacingAdj(origin)}, and fully customisable.`,
            ...
            faqs: [
                getThereFaq(origin),
                visaOrTravelFaq(origin),
                { q: `How many days should I plan coming from ${origin.city}?`, a: `We recommend factoring the ${origin.flightBand} into the trip length, typically a 5 to 7 day Golden Triangle${origin.domestic ? "" : " with an arrival buffer"}, extendable into Rajasthan or the Himalayas.` },
            ],
        };
    }
