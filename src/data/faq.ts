...
export const faqTopics: FaqTopic[] = [
    {
        ...
        questions: [
            ...
            },
            {
                ...
                a: "A focused Golden Triangle takes 4 to 5 days; 6 to 7 days allows an unhurried pace with Fatehpur Sikri, a Taj sunrise, and a slower Jaipur. Three days is possible as a high-efficiency sprint. We tailor duration to your arrival fatigue and interests.",
                links: [
            ...
            },
            {
                ...
                a: "Yes: Delhi → Agra → Jaipur → Delhi is the standard and most efficient sequence. It starts at the main international gateway (Delhi), routes the Agra to Jaipur leg via Fatehpur Sikri as a sightseeing drive, and returns to Delhi for departure. We sequence it around the Taj sunrise and the Friday Taj closure.",
                links: [
    ...
    },
    {
        ...
        questions: [
            ...
            },
            {
                ...
                a: "For peak season (October to March) and palace hotels, Taj sunrise slots, or wedding venues, 2 to 4 months ahead is advisable. Bespoke itineraries can be assembled faster; the constraint is usually premium accommodation and festival dates rather than logistics.",
        ...
        questions: [
            {
                ...
                a: "October to March is the prime window for North India, soft light, comfortable days, clean photography air. November to February is peak (book early). April to June is severe heat (dawn-only sightseeing); July to September monsoon is quiet, green, and private but variable.",
            ...
            },
            {
                ...
                a: "Yes, July to September is the quietest, most private time, with dramatic skies and emerald gardens. Rain is intermittent rather than constant in the North. We keep the itinerary weather-flexible and time the Taj for clear windows.",
            },
            {
                slug: "best-time-for-rajasthan",
                q: "When is the best time for Rajasthan?",
                a: "October to March for the desert cities (Jodhpur, Jaisalmer); September to March for Udaipur's lakes. Summer is extreme desert heat; the Pushkar Camel Fair and Jaisalmer Desert Festival fall in this window.",
