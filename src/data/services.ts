// Services cluster (grid E4 to E7). Local-SEO operational pages for
...
export function getServiceCityContent(
    ...
    return {
        ...
        intro: [
            ...
            `${dest.name} is ${dest.region === "Golden Triangle" ? "a core Golden Triangle base, rentals here typically run the Delhi to Agra to Jaipur arc and monument days" : `a ${dest.region} base, rentals here cover transfers, exploration, and onward circuit travel`}. The vehicle can extend seamlessly beyond ${dest.state}.`,
