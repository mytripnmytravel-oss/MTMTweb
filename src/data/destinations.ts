...
const coreDestinations: Destination[] = [
    {
        ...
        howToReach: [
            ...
            { mode: "Private Fleet", detail: "Our orthopedic-grade Innova Crysta and luxury sedans run the full Delhi to Agra to Jaipur arc with GPS telemetry." },
        ],
        whereToStay: [
    ...
    },
    {
        ...
        bestTime: {
            window: "October to March",
            narrative:
                "Delhi's pleasant season runs October to March, with crisp, sightseeing-friendly days. December and January can bring morning fog that delays flights, our planners build buffer into arrival days. April to June is extreme heat; July to September is monsoon humidity with lush gardens. For the Golden Triangle, an October to March launch produces the best light across all three cities.",
        },
        thingsToDo: [
    ...
    },
    {
        ...
        howToReach: [
            ...
            { mode: "Rail", detail: "The Delhi to Jaipur Shatabdi and Vande Bharat services are fast; we handle station transfers." },
    ...
    },
    {
        ...
        quickFacts: [
            ...
            { label: "Ideal stay", value: "2 to 3 nights" },
        ...
        bestTime: {
            window: "September to March",
            narrative:
                "Udaipur is at its most photogenic from September to March, when post-monsoon lakes are full and the light is soft on the marble. October to February is peak wedding and celebration season, palace venues book months ahead. Summer (April to June) is hot and the lakes can recede; the monsoon is brief, dramatic, and refills the lakes for the prime season.",
        },
        thingsToDo: [
        ...
        howToReach: [
            ...
            { mode: "Road", detail: "The Jaipur to Udaipur leg (≈ 6.5 hrs) can route via Pushkar or Chittorgarh as a chauffeured sightseeing arc." },
    ...
    },
    {
        ...
        thingsToDo: [
            ...
            { name: "Jain temples", blurb: "Seven interconnected 12th to 15th-century temples inside the fort, finely carved.", category: "Culture" },
            { name: "Gadisar Lake", blurb: "A serene man-made reservoir ringed by shrines, best at sunrise.", category: "Nature" },
        ],
        howToReach: [
            { mode: "Road", detail: "The chauffeured Jodhpur to Jaisalmer leg (≈ 5 hrs) crosses the open Thar, a defining part of the route." },
    ...
    },
    {
        ...
        faqs: [
            ...
            { q: "When is the snake-boat race?", a: "The Nehru Trophy race is usually in August, during the monsoon. We can plan around it, but the calm-water cruising season is November to February." },
    ...
    },
    {
        ...
        bestTime: {
            window: "September to March",
            narrative:
                "September to March offers clear skies, lush post-monsoon estates, and comfortable cool days. The Neelakurinji bloom, which carpets the hills in blue, is a rare event roughly every 12 years. April to May is warmer but pleasant; June to August monsoon brings mist and heavy rain that obscures the views but maximises green. Winter is optimal for photography and estate walks.",
        },
        thingsToDo: [
            ...
            { name: "Top Station viewpoint", blurb: "The Kerala to Tamil Nadu ridge with valley panoramas at sunrise.", category: "Nature" },
        ...
        faqs: [
            ...
            { q: "Is Munnar good in the monsoon?", a: "It is dramatically green but often mist-covered with heavy rain. For clear views and photography, September to March is best." },
    ...
    },
    {
        ...
        bestTime: {
            window: "October to March",
            narrative:
                "October to March is dry and comfortable for the Fort Kochi walk and waterfront. The Kochi-Muziris Biennale (December to April in its edition years) is a major draw. June to September monsoon is heavy on the coast; April to May is hot and humid. The winter window aligns with the rest of the Kerala circuit's prime season.",
        },
        thingsToDo: [
    ...
    },
    {
        ...
        intro: [
            ...
            "The heritage spine is the Ridge and Mall Road: Christ Church, the Gaiety Theatre, and the half-timbered Viceregal Lodge from which the British governed a subcontinent each summer. The approach itself is the headline, the UNESCO Kalka to Shimla toy train climbing through 102 tunnels and a hundred curves is one of the world's classic narrow-gauge journeys.",
        ...
        quickFacts: [
            ...
            { label: "Best known for", value: "Colonial Raj heritage, Kalka to Shimla toy train" },
            { label: "Ideal stay", value: "2 nights" },
            ...
            { label: "UNESCO", value: "Kalka to Shimla Railway" },
        ],
        bestTime: {
            window: "March to June, September to November",
            narrative:
                "March to June brings pleasant spring-summer days ideal for heritage walks and the toy train. September to November offers crisp post-monsoon clarity. December to February brings snow, atmospheric but with road and rail disruption. The monsoon (July to August) risks landslides on the mountain roads. Spring and autumn are optimal.",
        },
        thingsToDo: [
            { name: "Kalka to Shimla toy train", blurb: "The UNESCO narrow-gauge climb through 102 tunnels, the scenic stretch curated.", category: "Heritage" },
        ...
        howToReach: [
            { mode: "Rail", detail: "The UNESCO Kalka to Shimla narrow-gauge railway is the iconic approach; we curate the most scenic stretch." },
        ...
        faqs: [
            { q: "Is the toy train worth it?", a: "Decisively, the UNESCO Kalka to Shimla railway is one of the great mountain rail journeys. We curate the most scenic stretch with a fleet handover either side." },
            ...
            { q: "Does it snow in Shimla?", a: "Yes, December to February, which is atmospheric but disrupts roads and rail. Spring and autumn are the smoothest windows." },
    ...
    },
    {
        ...
        quickFacts: [
            ...
            { label: "Ideal stay", value: "5 to 7 nights" },
            { label: "Access", value: "Fly Leh (IXL), recommended over the road" },
            { label: "Season", value: "Roughly May to September" },
        ...
        bestTime: {
            ...
            narrative:
                "Leh is accessible roughly May to September. June to August is the reliable window with open passes and the Hemis festival; May and September are quieter with sharper light. Winter (October to April) seals most passes and drops temperatures far below freezing, only specialist winter itineraries operate. The first 24 to 36 hours must be a rest-and-acclimatise buffer regardless of season.",
        },
        thingsToDo: [
        ...
        howToReach: [
            ...
            { mode: "Road", detail: "The seasonal Manali to Leh and Srinagar to Leh drives are spectacular but demanding two-day high-altitude routes." },
        ...
        faqs: [
            { q: "Do I need to acclimatise in Leh?", a: "Yes, without exception. We build a 24 to 36 hour rest buffer on arrival and pace all sightseeing with medically aware chauffeur-guides and an oxygen-equipped fleet." },
            ...
            { q: "Is Ladakh open in winter?", a: "Most of it closes October to April. Only specialist winter itineraries operate; the standard season is May to September." },
        ],
    ...
    },
    {
        ...
        bestTime: {
            window: "March to May, October to December",
            narrative:
                "March to May brings rhododendron bloom and clear views; October to December offers the sharpest post-monsoon Kanchenjunga clarity. The monsoon (June to September) is heavy with landslide risk on the mountain roads. Winter is cold with possible snow on the Silk Route. Spring and autumn are optimal for both views and high-altitude access.",
        },
        thingsToDo: [
        ...
        faqs: [
            ...
            { q: "When are Kanchenjunga views best?", a: "Clear post-monsoon mornings October to December, and spring March to May. Monsoon obscures the peak." },
    ...
    },
    {
        ...
        bestTime: {
            window: "March to May, October to December",
            narrative:
                "October to December gives the sharpest, most reliable Kanchenjunga views; March to May adds rhododendron bloom. The monsoon (June to September) usually curtains the peak and risks landslides on the West Sikkim roads. Winter is cold but clear. For the view that defines Pelling, autumn and spring are optimal.",
        },
        thingsToDo: [
        ...
        howToReach: [
            { mode: "Road", detail: "The chauffeured Gangtok to Pelling leg (≈ 4.5 hrs) is a scenic West Sikkim drive." },
        ...
        faqs: [
            ...
            { q: "When are views most reliable?", a: "October to December for the clearest post-monsoon mornings; spring also works. Monsoon usually obscures the peak." },
    ...
    },
    {
        ...
        quickFacts: [
            ...
            { label: "Ideal stay", value: "1 to 2 nights (from Gangtok)" },
            { label: "From Gangtok", value: "≈ 120 km · 6 hrs" },
            { label: "Permits", value: "Protected-area permit required" },
            { label: "Season", value: "March to mid-June, October to December" },
            { label: "Pacing", value: "Acclimatised, permit-managed" },
        ],
        bestTime: {
            window: "March to mid-June, October to December",
            narrative:
                "Mid-March to mid-June is the rhododendron and primula bloom in Yumthang, the signature season. October to December offers clear, crisp high-valley views. The monsoon (late June to September) brings serious landslide risk on the North Sikkim road. Deep winter can close the route with snow. Spring is the iconic window.",
        },
        thingsToDo: [
        ...
        howToReach: [
            { mode: "Road", detail: "The chauffeured Gangtok to Lachung leg (≈ 6 hrs) through North Sikkim, permits managed." },
    ...
    },
    {
        ...
        quickFacts: [
            ...
            { label: "Ideal stay", value: "1 to 2 nights (arrival/departure)" },
            { label: "Airport", value: "Veer Savarkar Intl (IXZ)" },
            { label: "To Havelock", value: "≈ 1.5 to 2 hrs by premium ferry" },
        ...
        bestTime: {
            window: "October to May",
            narrative:
                "October to May is the dry, calm-sea season ideal for ferry transfers and water activities. December to March is peak with the best visibility. The southwest monsoon (June to September) brings rough seas that disrupt inter-island ferries and water sports. For seamless island logistics, plan within the October to May window.",
        },
        thingsToDo: [
        ...
        faqs: [
            ...
            { q: "How do I get to Havelock?", a: "By premium fast ferry, roughly 1.5 to 2 hours, with booking and luggage logistics managed by us." },
            ...
            { q: "When should I avoid the Andamans?", a: "The June to September monsoon brings rough seas that disrupt ferries. October to May is the reliable window." },
        ],
    ...
    },
    {
        ...
        quickFacts: [
            ...
            { label: "Ideal stay", value: "3 to 4 nights" },
            { label: "From Port Blair", value: "≈ 1.5 to 2 hrs by premium ferry" },
            { label: "Signature", value: "Diving + beachfront luxury" },
            { label: "Activity", value: "Scuba, snorkelling, sea kayaking" },
            { label: "Season", value: "October to May" },
            { label: "Official name", value: "Swaraj Dweep" },
        ],
        bestTime: {
            window: "October to May",
            narrative:
                "October to May offers calm seas, excellent underwater visibility, and reliable ferries. December to April is peak dive season with the clearest water. The southwest monsoon (June to September) brings rough seas, reduced visibility, and ferry disruption. For diving and beach time, the dry window is essential.",
        },
        thingsToDo: [
        ...
        howToReach: [
            { mode: "Private Fleet", detail: "Managed premium fast-ferry from Port Blair (≈ 1.5 to 2 hrs) with luggage handled." },
        ...
        faqs: [
            ...
            { q: "How do I reach Havelock?", a: "By managed premium fast ferry from Port Blair, around 1.5 to 2 hours; we handle booking and luggage." },
            { q: "Is Havelock good in the monsoon?", a: "No, June to September brings rough seas and poor visibility. October to May is the diving and beach window." },
        ],
    ...
    },
    {
        ...
        quickFacts: [
            ...
            { label: "From Port Blair", value: "≈ 1 to 1.5 hrs by ferry" },
        ...
        bestTime: {
            window: "October to May",
            narrative:
                "October to May brings calm seas, clear water, and reliable ferries, ideal for Neil's slow beach rhythm. December to April is the clearest. The monsoon (June to September) brings rough crossings and is best avoided for the inter-island legs. Plan Neil within the dry season alongside the rest of the Andaman circuit.",
        },
        thingsToDo: [
        ...
        howToReach: [
            { mode: "Private Fleet", detail: "Managed ferry from Havelock (≈ 1 hr) or Port Blair (≈ 1 to 1.5 hrs), logistics handled." },
    ...
    },
    {
        ...
        bestTime: {
            window: "October to March",
            narrative:
                "October to March is comfortable for the lake and ghats. The Pushkar Camel Fair (around Kartik Purnima, October to November) is the headline event, book luxury tents months ahead. Summer (April to June) is severe desert heat; the monsoon is brief. For the fair, plan precisely around the lunar date; otherwise the cool winter window is ideal.",
        },
        thingsToDo: [
        ...
        howToReach: [
            { mode: "Road", detail: "The chauffeured Jaipur to Pushkar leg (≈ 3 hrs) is a standard Rajasthan circuit extension." },
        ...
        faqs: [
            { q: "When is the Pushkar Camel Fair?", a: "Around Kartik Purnima (October to November); the exact dates shift yearly with the lunar calendar. We plan precisely around it and secure luxury tents well ahead." },
    ...
    },
    {
        ...
        quickFacts: [
            ...
            { label: "Ideal stay", value: "2 nights (3 to 4 safaris)" },
        ...
        howToReach: [
            { mode: "Road", detail: "The chauffeured Jaipur to Ranthambore leg (≈ 3.5 hrs) is the standard wildlife extension." },
        ...
        faqs: [
            ...
            { q: "When is the park closed?", a: "Core zones close during the monsoon, roughly July to September. The reserve is best October to April." },
    ...
    },
    {
        ...
        howToReach: [
            { mode: "Road", detail: "The chauffeured Delhi to Rishikesh leg (≈ 5.5 hrs) is the standard approach." },
    ...
    },
    {
        ...
        bestTime: {
            window: "March to June, September to November",
            narrative:
                "March to June brings clear Dhauladhar views and good trekking; September to November offers crisp post-monsoon air. The monsoon (July to August) is among the wettest in India with leech-prone trails and landslide risk. Winter is cold with occasional snow that closes upper trails. Spring and autumn are optimal for both views and the Triund trek.",
        },
        thingsToDo: [
        ...
        howToReach: [
            ...
            { mode: "Rail", detail: "The Pathankot to Kangra narrow-gauge is scenic; we handle the onward mountain transfer." },
        ...
        faqs: [
            ...
            { q: "When should I avoid Dharamshala?", a: "The July to August monsoon is extremely wet with leech-prone trails. Spring and autumn are best for views and trekking." },
        ],
    ...
    },
    {
        ...
        bestTime: {
            window: "September to March",
            narrative:
                "September to March offers calm seas and pleasant humidity ideal for the coast and Ayurveda programmes. December to February is peak. The monsoon (June to August) is heavy on the coast, though monsoon Ayurveda (Karkidaka chikitsa) is a traditional treatment season for serious wellness guests. April to May is hot and humid. Winter is optimal for a beach-and-wellness close.",
        },
        thingsToDo: [
    ...
    },
    {
        ...
        bestTime: {
            window: "September to March",
            narrative:
                "September to March offers pleasant, clear weather ideal for Periyar boat trips, guided walks, and spice tours. The dry pre-summer months can concentrate wildlife near the lake. The monsoon (June to August) is heavy and lush but limits some activities. April to May is warmer but viable. The cool post-monsoon window is optimal.",
        },
        thingsToDo: [
    ...
    },
    {
        ...
        answer:
            "Chittorgarh (Chittor) is a city in southern Rajasthan, India, home to Chittorgarh Fort, the largest fort in India and a UNESCO World Heritage Site as part of the Hill Forts of Rajasthan. Spread over 280 hectares on a 180 m hill, it contains the Vijay Stambh and Kirti Stambh victory towers, palaces, and temples, and is central to Rajput history and the legend of Rani Padmini. It sits on the Udaipur to Bundi axis. MyTripMyTravel operates it as a heritage leg with escorted access and an expert guide.",
        intro: [
            ...
            "MyTripMyTravel sequences Chittorgarh as a heritage stop on the Udaipur to Bundi route, with an expert guide and escorted access timed against the light.",
        ],
        quickFacts: [
            { label: "State", value: "Rajasthan" },
            ...
            { label: "Best as", value: "Udaipur to Bundi heritage leg" },
        ],
        bestTime: {
            window: "October to March",
            narrative:
        ...
        howToReach: [
            { mode: "Road", detail: "The chauffeured Udaipur to Chittorgarh leg (≈ 2.5 hrs) is a standard heritage extension." },
        ...
        faqs: [
            ...
            { q: "How does it fit a Rajasthan trip?", a: "As a heritage leg on the Udaipur to Bundi axis, roughly 2.5 hours from Udaipur." },
        ],
    ...
    },
    {
        ...
        bestTime: {
            window: "March to June, September to November",
            narrative:
                "March to June is the pleasant summer-retreat season; September to November offers crisp post-monsoon Himalayan clarity. December to February brings cold and occasional snow. The monsoon (July to August) risks landslides on the hill roads. Spring and autumn are optimal for lake activity and mountain views.",
        },
        thingsToDo: [
        ...
        howToReach: [
            { mode: "Road", detail: "The chauffeured Delhi to Nainital leg (≈ 7 hrs) is the standard approach." },
        ...
        faqs: [
            ...
            { q: "When are Himalayan views best?", a: "Clear post-monsoon days September to November, and spring; monsoon obscures the peaks and risks landslides." },
    ...
    },
    {
        ...
        bestTime: {
            window: "March to June, September to November",
            narrative:
                "March to June is the classic summer-retreat window; September to November offers clear post-monsoon Doon and Himalaya views. December to February can bring snow. The monsoon (July to August) is heavy in Garhwal with landslide risk. Spring and autumn are optimal.",
        },
        thingsToDo: [
        ...
        faqs: [
            ...
            { q: "When should I avoid Mussoorie?", a: "The July to August Garhwal monsoon, which is heavy with landslide risk. Spring and autumn are best." },
        ],
    ...
    },
    {
        ...
        quickFacts: [
            { label: "State", value: "Kerala" },
            { label: "Altitude", value: "≈ 700 to 2,100 m" },
        ...
        bestTime: {
            window: "October to May",
            narrative:
                "October to May is the pleasant, accessible window, post-monsoon greenery into the dry season, good for trekking, safaris, and estate visits. The southwest monsoon (June to September) is very heavy in the Ghats with leech-prone trails and possible sanctuary closures. The cool dry months are optimal.",
        },
        thingsToDo: [
        ...
        faqs: [
            ...
            { q: "Is the monsoon a bad time for Wayanad?", a: "For trekking and safaris, yes, June to September is very heavy in the Ghats with leech-prone trails. October to May is best." },
        ],
    ...
    },
    {
        ...
        bestTime: {
            window: "October to March",
            narrative:
                "October to March is the comfortable season, cool, clear, and ideal for the temples and viewpoints. Summer (April to June) is the peak domestic-tourism period because of the altitude relief from the plains; we plan around the crowds in those months. The monsoon greens the Aravallis but can fog viewpoints. Winter is optimal for unhurried sightseeing.",
        },
        thingsToDo: [
            { name: "Dilwara Jain temples", blurb: "Five 11th to 13th-century marble temples, escorted visit timed against group windows, with photography etiquette handled.", category: "Heritage" },
        ...
        howToReach: [
            { mode: "Road", detail: "The chauffeured Udaipur to Mount Abu leg (≈ 3.5 hrs) is the standard southern-Rajasthan approach." },
        ...
        whereToStay: [
            ...
            { tier: "Lakefront tier", detail: "Nakki Lake to facing hotels for the walking-distance core." },
        ],
        whereToEat: [
    ...
    },
    {
        ...
        intro: [
            ...
            "MyTripMyTravel uses Bundi as a quieter heritage extension on the Udaipur to Chittorgarh to Ranthambore axis, with escorted access timed against the light.",
        ],
        quickFacts: [
        ...
        whereToStay: [
            ...
            { tier: "Lakeside tier", detail: "Nawal Sagar to facing stays for the palace reflection view." },
        ],
        whereToEat: [
            { name: "Heritage haveli table", detail: "A Hadoti-Rajasthani menu in a painted-haveli courtyard." },
            { name: "Rooftop lake dining", detail: "Nawal Sagar to facing rooftop tables framed against the floodlit palace." },
        ...
        faqs: [
            ...
            { q: "How does Bundi fit a Rajasthan trip?", a: "As a quieter heritage extension on the Udaipur to Chittorgarh to Ranthambore axis, off the main marquee loop." },
    ...
    },
    {
        ...
        bestTime: {
            window: "October to March",
            narrative:
                "October to March is the calm-sea season for the cliff walk, the beach, and clifftop Ayurveda. December to February is peak. The southwest monsoon (June to August) is very heavy on the south Kerala coast. April to May is hot and humid. The dry winter window is optimal.",
        },
        thingsToDo: [
        ...
        faqs: [
            ...
            { q: "When should I avoid Varkala?", a: "The June to August monsoon, heavy on the south Kerala coast. October to March is the calm-sea window." },
        ],
    ...
    },
    {
        ...
        quickFacts: [
            ...
            { label: "Ideal stay", value: "1 to 2 nights (from Gangtok)" },
            { label: "From Gangtok", value: "≈ 130 km · 6 to 7 hrs" },
            { label: "Permits", value: "Protected-area permit required" },
            { label: "Season", value: "March to mid-June, October to November" },
            { label: "Pacing", value: "Acclimatised; medically aware" },
        ],
        bestTime: {
            window: "March to mid-June, October to November",
            narrative:
        ...
        howToReach: [
            { mode: "Road", detail: "The chauffeured Gangtok to Lachen leg (≈ 6 to 7 hrs) through North Sikkim with permit checkpoints." },
    ...
    },
    {
        ...
        bestTime: {
            window: "January to March (ski) · April to June, September to November (meadow & views)",
            narrative:
                "January to March is the skiing window, snow conditions and groomed slopes when the season delivers. April to June and September to November are the open-meadow and clearest-Nanda-Devi window. The monsoon (July to August) brings serious Garhwal landslide risk and is avoided. Winter outside the ski season can seal access. Plan to the purpose: snow or peak views.",
        },
        thingsToDo: [
            ...
            { name: "Auli to Gorson trek", blurb: "An alpine-meadow walk in summer through oak and rhododendron.", category: "Adventure" },
    ...
    },
    {
        ...
        bestTime: {
            window: "October to March",
            narrative:
                "October to March is the calm-sea, comfortable-coast season for fort visits and beach time. December to February is peak. The southwest monsoon (June to August) is heavy on the north Kerala coast. April to May is hot and humid. Winter is optimal.",
        },
        thingsToDo: [
        ...
        faqs: [
            ...
            { q: "When is the best time?", a: "October to March for the calm sea and comfortable coast. The June to August monsoon is heavy and best avoided." },
        ],
    ...
    },
    {
        ...
        quickFacts: [
            ...
            { label: "Best season", value: "November to February (peak winter migration)" },
    ...
    },
    {
        ...
        bestTime: {
            window: "Mid-April to early June, September to October",
            narrative:
    ...
    },
    {
        ...
        bestTime: {
            window: "October to December, March to May",
            narrative:
    ...
    },
    {
        ...
        quickFacts: [
            { label: "State", value: "Himachal Pradesh (Kullu district)" },
            { label: "Altitude", value: "1,500 to 1,800 m" },
    ...
    },
    {
        ...
        quickFacts: [
            ...
            { label: "Ideal stay", value: "1 to 2 nights (often a half-day extension from Rishikesh)" },
        ...
        faqs: [
            { q: "What time is the Ganga Aarti at Haridwar?", a: "Sunset, typically 6 to 7 pm in summer, 5.30 to 6.30 pm in winter. The ceremony runs about 45 minutes. We reserve elevated ghat seating in advance for our guests." },
    ...
    },
    {
        ...
        quickFacts: [
            ...
            { label: "Altitude", value: "3,200 to 4,500 m" },
            { label: "Best known for", value: "Tabo Monastery (996 AD), Key Monastery, cold-desert landscape" },
            { label: "Ideal stay", value: "7 to 10 days minimum (with acclimatisation)" },
    ...
    },
    {
        ...
        intro: [
            ...
            "MyTripMyTravel uses Ravangla as the slow, lower-altitude alternative on the Sikkim circuit, or as a Gangtok to Pelling bridge that holds its own as a stop rather than a transit.",
        ],
        quickFacts: [
        ...
        bestTime: {
            window: "March to May, October to December",
            narrative:
                "March to May brings rhododendron and clear views; October to December offers the sharpest post-monsoon Kanchenjunga clarity. The monsoon (June to September) is heavy with landslide risk on the south Sikkim road. Winter is cold and quiet. Spring and autumn are optimal.",
        },
        thingsToDo: [
