...
export const SERVICE_ITEMS: ServiceItem[] = [
    ...
    },
    {
        ...
        links: [
            { label: "Royal weddings", href: "/weddings" },
            { label: "Conference / MICE", href: "/corporate/events/conference-mice" },
            { label: "Grand weddings (150–400)", href: "/weddings/by-guest-count/grand" },
            BOOK,
        ],
    },
    {
        ...
        faqs: [
            ...
            { q: "How long does planning take?", a: "Most missions: 1–2 weeks of iterative briefing. Complex multi-region or wedding-scale trips: longer, with explicit milestone reviews." },
        ],
        links: [
