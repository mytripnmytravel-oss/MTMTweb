// Weddings cluster (grid F7 to F9). Categorical sub-layers beneath the
// existing bespoke /weddings page (left untouched): venue types,
// guest-count tiers, and service lines. No fabricated people or venues, // content is categorical and routes specifics to the weddings wing.
...
export const weddingCategories: WeddingCategory[] = [
    ...
    },
    {
        ...
        items: [
            ...
            {
                slug: "classic",
                name: "Classic Weddings (50 to 150)",
                answer:
                    "A classic wedding of 50 to 150 guests is the most common royal-wedding scale. MyTripMyTravel matches it to palace hotels or heritage estates with full multi-event choreography across the wedding days, room-block management, and convoy. Specifics confirmed by the weddings wing.",
                intro: [
                    "50 to 150 guests is the classic band, large enough for the full sequence of mehndi, sangeet, ceremony, and reception, small enough that a palace hotel or heritage estate can host it without buyout-scale complexity.",
                ...
                faqs: [
                    { q: "What venue suits 100 wedding guests?", a: "A palace hotel or heritage estate, the classic 50 to 150 band, which hosts the full mehndi-to-reception sequence without buyout-scale complexity." },
            ...
            {
                slug: "grand",
                name: "Grand Weddings (150 to 400)",
                answer:
                    "A grand wedding of 150 to 400 guests requires large palace or fort venues and serious logistics, multi-property room blocks, convoy fleets, and dedicated on-ground coordination. MyTripMyTravel operates these as full managed missions. Specifics confirmed by the weddings wing.",
                intro: [
                    "150 to 400 guests moves a wedding into fort and large-palace territory, where the celebration's success is decided by logistics as much as design. At this scale, a wedding is an operation that happens to be beautiful.",
                ...
                faqs: [
                    { q: "Can you handle a 300-guest wedding in India?", a: "Yes, grand weddings (150 to 400) use large palace or fort venues with multi-property block operations and convoy logistics, run as a full managed mission." },
