        ...
        <SmoothScroll>
            <main className="min-h-screen bg-white relative overflow-hidden">
                ...
                <section className="pt-60 pb-16 container mx-auto px-6 relative z-10">
                    ...
                    <h4 className="text-sunset-orange font-semibold uppercase tracking-[0.8em] text-sm mb-6">Golden Triangle</h4>
                    ...
                    <p className="text-2xl md:text-3xl font-semibold text-royal-blue leading-snug tracking-tight max-w-5xl mb-10">
                        {content.answer}
                    </p>
                        ...
                        {content.packages.map((p, idx) => (
                            ...
                            >
                                <Link
                                    ...
                                    className="block glass-card rounded-2xl overflow-hidden group border-royal-blue/5 hover:border-sunset-orange/30 transition-all duration-700 h-full"
                                >
                ...
                <section className="py-24 container mx-auto px-6">
                    <h4 className="text-sunset-orange font-semibold uppercase tracking-[0.6em] text-xs mb-5">Explore Other Slices</h4>
                    <div className="flex flex-wrap gap-3">
                        ...
                        <Link href="/destinations/region/golden-triangle" className="px-6 py-3 glass-card rounded-2xl border-royal-blue/10 font-semibold uppercase text-[11px] tracking-widest text-royal-blue hover:bg-sunset-orange hover:text-white transition-all duration-500 flex items-center gap-2">
