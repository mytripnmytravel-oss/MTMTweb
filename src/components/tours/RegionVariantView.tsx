        ...
        <SmoothScroll>
            <main className="min-h-screen bg-white relative overflow-hidden">
                ...
                <section className="pt-60 pb-16 container mx-auto px-6 relative z-10">
                    ...
                    <h4 className="text-sunset-orange font-black uppercase tracking-[0.8em] text-sm mb-6">{content.regionName}</h4>
                    ...
                    <p className="text-2xl md:text-3xl font-black text-royal-blue leading-snug tracking-tight max-w-5xl mb-10">{content.answer}</p>
                ...
                <section className="py-24 container mx-auto px-6">
                    <h4 className="text-sunset-orange font-black uppercase tracking-[0.6em] text-xs mb-5">Other slices of {content.regionName}</h4>
                    <div className="flex flex-wrap gap-3">
                        {siblings.map((s) => (
                            <Link key={s.href} href={s.href} className="px-6 py-3 glass-card rounded-2xl border-royal-blue/10 font-black uppercase text-[11px] tracking-widest text-royal-blue hover:bg-sunset-orange hover:text-white transition-all duration-500">{s.label}</Link>
                        ))}
                        <Link href={`/destinations/region/${content.regionSlug}`} className="px-6 py-3 glass-card rounded-2xl border-royal-blue/10 font-black uppercase text-[11px] tracking-widest text-royal-blue hover:bg-sunset-orange hover:text-white transition-all duration-500 flex items-center gap-2">{content.regionName} destinations <ArrowRight size={14} /></Link>
                    </div>
                </section>
