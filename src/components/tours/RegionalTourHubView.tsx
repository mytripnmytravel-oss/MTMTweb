            ...
            <main className="min-h-screen bg-white text-royal-blue overflow-hidden">
                ...
                <section className="relative h-[58vh] flex items-end overflow-hidden">
                    ...
                    <div className="container mx-auto px-6 relative z-10 pb-16">
                        ...
                        <h4 className="text-sunset-orange font-black uppercase tracking-[0.6em] text-xs mb-5">{hub.tagline}</h4>
                        <CharBlurIn text={h1.toUpperCase()} className="text-4xl md:text-7xl font-black text-white uppercase tracking-tighter leading-[0.9] block" />
                    </div>
                </section>
                ...
                <section className="py-24 container mx-auto px-6">
                    <div className="max-w-5xl">
                        ...
                        <p className="text-2xl md:text-4xl font-black text-royal-blue leading-snug tracking-tight mb-12">{answer}</p>
                ...
                <section className="py-20 bg-royal-blue/5">
                    <div className="container mx-auto px-6">
                        <div className="flex items-center gap-5 mb-10">
                            <h2 className="text-3xl md:text-5xl font-black text-royal-blue uppercase tracking-tighter">{hub.name} packages</h2>
                            <div className="h-px flex-1 bg-royal-blue/10" />
                            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-royal-blue/40">{packages.length} listed</span>
                        </div>
                        {packages.length > 0 ? (
                            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                {packages.map((p, idx) => (
                                    <motion.div key={p.id} initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: (idx % 3) * 0.05 }}>
                                        <Link href={`/tours/${packageSlug(p)}`} className="block glass-card rounded-[2.5rem] overflow-hidden group border-royal-blue/5 hover:border-sunset-orange/30 transition-all duration-700 h-full">
                                            ...
                                            <div className="p-7">
                                                ...
                                                <div className="flex items-center justify-between pt-5 border-t border-royal-blue/5">
                                                    ...
                                                    <span className="font-black uppercase text-[10px] tracking-[0.3em] flex items-center gap-2 text-royal-blue group-hover:text-sunset-orange transition-colors">Open <ArrowRight size={14} /></span>
                                                </div>
                                            </div>
                                        </Link>
                                    </motion.div>
                            ...
                            <div className="glass-card rounded-3xl p-12 border-royal-blue/5 max-w-3xl">
                                ...
                                <Link href="/booking" className="inline-block px-7 py-4 bg-sunset-orange text-white rounded-2xl font-black uppercase text-[11px] tracking-widest hover:bg-royal-blue transition-all duration-500">Brief the Planning Desk</Link>
                            </div>
                        )}
                    </div>
                </section>
                ...
                <section className="py-24 container mx-auto px-6">
                    <div className="text-center mb-14">
                        ...
                        <CharBlurIn text={`${hub.name.toUpperCase()} TOURS FAQ`} className="text-2xl md:text-5xl font-black text-royal-blue uppercase tracking-tighter block leading-none" />
                    </div>
                ...
                <section className="py-20 bg-royal-blue/5">
                    <div className="container mx-auto px-6">
                        ...
                        <div className="flex flex-wrap gap-3">
                            <Link href={`/destinations/region/${hub.destinationsRegionSlug}`} className="px-6 py-3 glass-card rounded-2xl border-royal-blue/10 font-black uppercase text-[11px] tracking-widest text-royal-blue hover:bg-sunset-orange hover:text-white transition-all duration-500">{hub.name} destinations</Link>
                            <Link href="/tours" className="px-6 py-3 glass-card rounded-2xl border-royal-blue/10 font-black uppercase text-[11px] tracking-widest text-royal-blue hover:bg-sunset-orange hover:text-white transition-all duration-500">All tour packages</Link>
                            <Link href="/fleet" className="px-6 py-3 glass-card rounded-2xl border-royal-blue/10 font-black uppercase text-[11px] tracking-widest text-royal-blue hover:bg-sunset-orange hover:text-white transition-all duration-500">Elite Fleet</Link>
                            <Link href="/services/inter-city" className="px-6 py-3 glass-card rounded-2xl border-royal-blue/10 font-black uppercase text-[11px] tracking-widest text-royal-blue hover:bg-sunset-orange hover:text-white transition-all duration-500 flex items-center gap-2">Inter-city transfers <ArrowRight size={14} /></Link>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-28 container mx-auto px-6">
                    <div className="glass-card p-12 md:p-20 rounded-[4rem] bg-royal-blue text-white text-center shadow-2xl relative overflow-hidden">
                        ...
                        <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tighter leading-none mb-10 relative z-10">Architect a <span className="text-sunset-orange">{hub.name}</span> mission</h2>
                        <Magnetic>
