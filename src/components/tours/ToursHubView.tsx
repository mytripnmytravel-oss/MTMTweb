            ...
            <main className="min-h-screen bg-white relative overflow-hidden">
                ...
                <section className="pt-60 pb-20 container mx-auto px-6 relative z-10">
                    <div className="max-w-4xl">
                        ...
                        <h4 className="text-sunset-orange font-semibold uppercase tracking-[0.8em] text-sm mb-6">Master Packages</h4>
                        <CharBlurIn text="THE TOUR ARCHIVE" className="text-5xl md:text-8xl font-semibold text-royal-blue uppercase tracking-tight leading-[0.85] block mb-8" />
                ...
                {grouped.map((group) => (
                    <section key={group.location} className="pb-24 container mx-auto px-6 relative z-10">
                        <div className="flex items-center gap-5 mb-10">
                            <h2 className="text-3xl md:text-5xl font-semibold text-royal-blue uppercase tracking-tight">{group.location}</h2>
                            <div className="h-px flex-1 bg-royal-blue/10" />
                            <span className="text-[10px] font-semibold uppercase tracking-[0.3em] text-royal-blue/40">{group.items.length} missions</span>
                        </div>
