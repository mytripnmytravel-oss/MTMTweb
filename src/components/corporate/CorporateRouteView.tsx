            ...
            <main className="min-h-screen bg-white text-royal-blue overflow-hidden">
                ...
                <section className="relative h-[56vh] flex items-end overflow-hidden">
                    ...
                    <div className="container mx-auto px-6 relative z-10 pb-14">
                        ...
                        <h4 className="text-sunset-orange font-black uppercase tracking-[0.6em] text-xs mb-5">Corporate Offsite Route</h4>
                    ...
                    <div className="max-w-5xl">
                        ...
                        <div className="flex flex-wrap gap-4 mt-12">
                            <div className="glass-card rounded-2xl px-7 py-4 border-royal-blue/5 flex items-center gap-3">
                                ...
                                <span className="font-black uppercase text-xs tracking-widest text-royal-blue">Fly: {route.originGateway} → {destination.name}</span>
                            </div>
                            <div className="glass-card rounded-2xl px-7 py-4 border-royal-blue/5">
                                <span className="font-black uppercase text-xs tracking-widest text-royal-blue">Ground operation: MyTripMyTravel</span>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-20 bg-royal-blue/5">
                    <div className="container mx-auto px-6">
                        <h4 className="text-sunset-orange font-black uppercase tracking-[0.6em] text-xs mb-8">On-Ground Inclusions in {destination.name}</h4>
                ...
                <section className="py-24 container mx-auto px-6">
                    <div className="text-center mb-14">
                        ...
                        <CharBlurIn text={`${route.originLabel} → ${destination.name} FAQ`.toUpperCase()} className="text-2xl md:text-5xl font-black text-royal-blue uppercase tracking-tighter block leading-none" />
                    </div>
                ...
                <section className="py-20 bg-royal-blue/5">
                    <div className="container mx-auto px-6">
                        ...
                        <div className="flex flex-wrap gap-3">
                            <Link href="/corporate" className="px-6 py-3 glass-card rounded-2xl border-royal-blue/10 font-black uppercase text-[11px] tracking-widest text-royal-blue hover:bg-sunset-orange hover:text-white transition-all duration-500">Corporate hub</Link>
                            <Link href="/corporate/by-team-size" className="px-6 py-3 glass-card rounded-2xl border-royal-blue/10 font-black uppercase text-[11px] tracking-widest text-royal-blue hover:bg-sunset-orange hover:text-white transition-all duration-500">By team size</Link>
                            <Link href="/corporate/events" className="px-6 py-3 glass-card rounded-2xl border-royal-blue/10 font-black uppercase text-[11px] tracking-widest text-royal-blue hover:bg-sunset-orange hover:text-white transition-all duration-500">Event types</Link>
                            <Link href={`/destinations/${destination.slug}`} className="px-6 py-3 glass-card rounded-2xl border-royal-blue/10 font-black uppercase text-[11px] tracking-widest text-royal-blue hover:bg-sunset-orange hover:text-white transition-all duration-500">{destination.name} brief</Link>
                            <Link href="/services/group-transport" className="px-6 py-3 glass-card rounded-2xl border-royal-blue/10 font-black uppercase text-[11px] tracking-widest text-royal-blue hover:bg-sunset-orange hover:text-white transition-all duration-500 flex items-center gap-2">Group transport <ArrowRight size={14} /></Link>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-28 container mx-auto px-6">
                    <div className="glass-card p-12 md:p-20 rounded-[4rem] bg-royal-blue text-white text-center shadow-2xl relative overflow-hidden">
                        ...
                        <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tighter leading-none mb-10 relative z-10">{route.originLabel} → <span className="text-sunset-orange">{destination.name}</span></h2>
                        <Magnetic>
                            <Link href="/booking" className="inline-block relative z-10 bg-sunset-orange text-white py-6 px-12 rounded-[2rem] font-black uppercase tracking-widest text-sm hover:bg-white hover:text-royal-blue transition-all duration-500 shadow-xl">Brief the Corporate Desk</Link>
                        </Magnetic>
                    </div>
                </section>
