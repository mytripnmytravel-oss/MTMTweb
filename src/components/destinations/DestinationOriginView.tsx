    ...
    return (
        <main className="min-h-screen bg-paper">
            ...
            <section className="relative flex h-[62vh] min-h-[460px] items-end overflow-hidden">
                ...
                <div className="container-x relative z-10 pb-14 pt-32">
                    ...
                    <div className="mb-4 flex items-center gap-2">
                        ...
                        <p className="eyebrow text-paper/70">{origin.city} to {dest.name}</p>
                    </div>
            ...
            <section className="section pt-0">
                <div className="container-x">
                    <div className="card p-8 sm:p-10">
                        <p className="eyebrow eyebrow-accent">{origin.city} to {dest.name}</p>
                        <div className="mt-8 grid gap-5 md:grid-cols-3">
                            ...
                            <div className="rounded-2xl border border-line bg-paper-dim/60 p-6">
                                ...
                                <h3 className="mt-3 text-[13px] font-semibold uppercase tracking-[0.12em] text-stone">Arrival day</h3>
                                <p className="mt-1.5 text-[14px] leading-relaxed text-muted">{content.arrivalNote.split(".")[0]}.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="border-y border-line bg-paper-dim/60 py-20 sm:py-24">
                <div className="container-x">
                    <p className="eyebrow eyebrow-accent">How we run the {origin.city} to {dest.name} route</p>
            ...
            <section className="section">
                <div className="container-x">
                    ...
                    <h2 className="display-3 mt-3 text-ink">{dest.name} from {origin.city}, your questions</h2>
                    <div className="mt-10 grid gap-6 md:grid-cols-2">
