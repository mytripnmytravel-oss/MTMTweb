            ...
            <main className="min-h-screen bg-white text-royal-blue overflow-hidden">
                ...
                <section className="relative h-[62vh] flex items-end overflow-hidden">
                    ...
                    <div className="container mx-auto px-6 relative z-10 pb-16">
                        ...
                        <div className="flex items-center gap-3 mb-5">
                            ...
                            <span className="text-sunset-orange font-black uppercase tracking-[0.6em] text-xs">{origin.city} → {monument.name}</span>
                        </div>
                ...
                <section className="pb-20 container mx-auto px-6">
                    <div className="glass-card rounded-[2.5rem] p-9 md:p-12 border-royal-blue/5 bg-royal-blue/5">
                        <h4 className="text-sunset-orange font-black uppercase tracking-[0.6em] text-xs mb-8">{origin.city} → {monument.name}</h4>
                ...
                <section className="py-20 bg-royal-blue/5">
                    <div className="container mx-auto px-6">
                        <h4 className="text-sunset-orange font-black uppercase tracking-[0.6em] text-xs mb-10">How we run the mission</h4>
                ...
                <section className="py-24 container mx-auto px-6">
                    <div className="text-center mb-14">
                        ...
                        <CharBlurIn text={`${monument.name.toUpperCase()} FROM ${origin.city.toUpperCase()}`} className="text-2xl md:text-5xl font-black text-royal-blue uppercase tracking-tighter block leading-none" />
                    </div>
                ...
                <section className="py-28 container mx-auto px-6">
                    <div className="glass-card p-12 md:p-20 rounded-[4rem] bg-royal-blue text-white text-center shadow-2xl relative overflow-hidden">
                        ...
                        <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tighter leading-none mb-10 relative z-10">Visit the <span className="text-sunset-orange">{monument.name}</span> from <span className="text-sunset-orange">{origin.city}</span></h2>
                        <Magnetic>
