            ...
            <main className="min-h-screen bg-white text-royal-blue overflow-hidden">
                ...
                <section className="relative h-[62vh] flex items-end overflow-hidden">
                    ...
                    <div className="container mx-auto px-6 relative z-10 pb-16">
                        ...
                        <div className="flex items-center gap-3 mb-5">
                            ...
                            <span className="text-sunset-orange font-black uppercase tracking-[0.6em] text-xs">{monument.name} · {content.monthLabel}</span>
                        </div>
                ...
                <section className="pb-20 container mx-auto px-6">
                    <div className="glass-card rounded-[2.5rem] p-9 md:p-12 border-royal-blue/5 bg-royal-blue/5">
                        <h4 className="text-sunset-orange font-black uppercase tracking-[0.6em] text-xs mb-8">{content.monthLabel} conditions for {monument.name}</h4>
                        <div className="grid md:grid-cols-3 gap-6">
                            <div className="bg-white rounded-2xl p-6 border border-royal-blue/5">
                                <Sun className="text-sunset-orange mb-3" size={22} />
                                <h3 className="font-black text-royal-blue uppercase tracking-tight text-sm mb-2">Weather + Light</h3>
                            ...
                            <div className="bg-white rounded-2xl p-6 border border-royal-blue/5">
                                ...
                                <h3 className="font-black text-royal-blue uppercase tracking-tight text-sm mb-2">Access</h3>
                ...
                <section className="py-20 bg-royal-blue/5">
                    <div className="container mx-auto px-6">
                        <h4 className="text-sunset-orange font-black uppercase tracking-[0.6em] text-xs mb-10">{monument.name} in {content.monthLabel} — operating notes</h4>
                        <div className="grid md:grid-cols-2 gap-6">
                            {content.points.map((p, i) => (
                                <motion.div key={i} initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.05 }} className="glass-card rounded-[2.5rem] p-9 border-royal-blue/5">
                                    <h3 className="text-xl md:text-2xl font-black text-royal-blue uppercase tracking-tighter mb-4 leading-tight">{p.label}</h3>
                ...
                <section className="py-24 container mx-auto px-6">
                    <div className="text-center mb-14">
                        ...
                        <CharBlurIn text={`${monument.name.toUpperCase()} · ${content.monthLabel.toUpperCase()} FAQ`} className="text-2xl md:text-5xl font-black text-royal-blue uppercase tracking-tighter block leading-none" />
                    </div>
                ...
                <section className="py-28 container mx-auto px-6">
                    <div className="glass-card p-12 md:p-20 rounded-[4rem] bg-royal-blue text-white text-center shadow-2xl relative overflow-hidden">
                        ...
                        <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tighter leading-none mb-10 relative z-10">Visit the <span className="text-sunset-orange">{monument.name}</span> in <span className="text-sunset-orange">{content.monthLabel}</span></h2>
                        <Magnetic>
