            ...
            <main className="min-h-screen bg-white text-royal-blue overflow-hidden">
                ...
                <section className="relative h-[62vh] flex items-end overflow-hidden">
                    ...
                    <div className="container mx-auto px-6 relative z-10 pb-16">
                        ...
                        <div className="flex items-center gap-3 mb-5">
                            <span className={`px-4 py-2 rounded-full text-[10px] font-black tracking-[0.3em] uppercase ${toneClass(content.verdictTone)}`}>{content.verdictTag}</span>
                            <span className="text-sunset-orange font-black uppercase tracking-[0.6em] text-xs">{dest.name} &middot; {content.monthLabel}</span>
                        </div>
                ...
                <section className="pb-20 container mx-auto px-6">
                    <div className="glass-card rounded-[2.5rem] p-9 md:p-12 border-royal-blue/5 bg-royal-blue/5">
                        <h4 className="text-sunset-orange font-black uppercase tracking-[0.6em] text-xs mb-8">{content.monthLabel} Climate &amp; Operations</h4>
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                            <div className="bg-white rounded-2xl p-6 border border-royal-blue/5">
                                <Sun className="text-sunset-orange mb-3" size={22} />
                                <h3 className="font-black text-royal-blue uppercase tracking-tight text-sm mb-2">Weather</h3>
                            ...
                            <div className="bg-white rounded-2xl p-6 border border-royal-blue/5">
                                ...
                                <h3 className="font-black text-royal-blue uppercase tracking-tight text-sm mb-2">Light</h3>
                            ...
                            <div className="bg-white rounded-2xl p-6 border border-royal-blue/5">
                                ...
                                <h3 className="font-black text-royal-blue uppercase tracking-tight text-sm mb-2">Crowd</h3>
                            ...
                            <div className="bg-white rounded-2xl p-6 border border-royal-blue/5">
                                ...
                                <h3 className="font-black text-royal-blue uppercase tracking-tight text-sm mb-2">Rainfall</h3>
                ...
                <section className="py-20 bg-royal-blue/5">
                    <div className="container mx-auto px-6">
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="glass-card rounded-[2.5rem] p-9 md:p-11 border-royal-blue/5">
                                <div className="flex items-center gap-3 mb-7">
                                    ...
                                    <h3 className="text-xl md:text-2xl font-black text-royal-blue uppercase tracking-tighter">What {content.monthLabel} delivers</h3>
                                </div>
                            ...
                            <div className="glass-card rounded-[2.5rem] p-9 md:p-11 border-royal-blue/5">
                                <div className="flex items-center gap-3 mb-7">
                                    ...
                                    <h3 className="text-xl md:text-2xl font-black text-royal-blue uppercase tracking-tighter">What {content.monthLabel} asks you to skip</h3>
                                </div>
                                <ul className="space-y-4">
                ...
                <section className="py-20 container mx-auto px-6">
                    <div className="glass-card rounded-[2.5rem] p-9 md:p-12 border-royal-blue/5 max-w-4xl">
                        <div className="flex items-center gap-3 mb-5">
                            <Clock className="text-sunset-orange" size={22} />
                            <h4 className="text-sunset-orange font-black uppercase tracking-[0.6em] text-xs">Recommended length in {content.monthLabel}</h4>
                        </div>
                        <p className="text-xl md:text-2xl font-black text-royal-blue leading-snug tracking-tight">{content.recommendedDuration}</p>
                        <div className="mt-7 flex flex-wrap gap-3">
                            <Link href={`/destinations/${dest.slug}/itinerary/3-day`} className="px-5 py-3 glass-card rounded-2xl border-royal-blue/10 font-black uppercase text-[11px] tracking-widest text-royal-blue hover:bg-sunset-orange hover:text-white transition-all duration-500">3-Day Itinerary</Link>
                            <Link href={`/destinations/${dest.slug}/itinerary/5-day`} className="px-5 py-3 glass-card rounded-2xl border-royal-blue/10 font-black uppercase text-[11px] tracking-widest text-royal-blue hover:bg-sunset-orange hover:text-white transition-all duration-500">5-Day Itinerary</Link>
                            <Link href={`/destinations/${dest.slug}/itinerary/7-day`} className="px-5 py-3 glass-card rounded-2xl border-royal-blue/10 font-black uppercase text-[11px] tracking-widest text-royal-blue hover:bg-sunset-orange hover:text-white transition-all duration-500">7-Day Itinerary</Link>
                            <Link href={`/destinations/${dest.slug}/itinerary/10-day`} className="px-5 py-3 glass-card rounded-2xl border-royal-blue/10 font-black uppercase text-[11px] tracking-widest text-royal-blue hover:bg-sunset-orange hover:text-white transition-all duration-500">10-Day Itinerary</Link>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-20 bg-royal-blue/5">
                    <div className="container mx-auto px-6">
                        <h4 className="text-sunset-orange font-black uppercase tracking-[0.6em] text-xs mb-10">{dest.name} &middot; {content.monthLabel} — Operating Notes</h4>
                        <div className="grid md:grid-cols-2 gap-6">
                            {content.facets.map((f, i) => (
                                <motion.div key={i} initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.06 }} className="glass-card rounded-[2.5rem] p-9 border-royal-blue/5">
                ...
                {content.pairedRegions.length > 0 && (
                    <section className="py-20 container mx-auto px-6">
                        <h4 className="text-sunset-orange font-black uppercase tracking-[0.6em] text-xs mb-5">{content.monthLabel} is also strong in</h4>
                        ...
                        <div className="flex flex-wrap gap-3">
                            {content.pairedRegions.map((r) => (
                                <Link key={r.href} href={r.href} className="px-6 py-3 glass-card rounded-2xl border-royal-blue/10 font-black uppercase text-[11px] tracking-widest text-royal-blue hover:bg-sunset-orange hover:text-white transition-all duration-500 flex items-center gap-2">
                ...
                <section className="py-20 bg-royal-blue text-white">
                    <div className="container mx-auto px-6">
                        <h4 className="text-sunset-orange font-black uppercase tracking-[0.6em] text-xs mb-10">{dest.name} month-by-month</h4>
                        <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
                            {content.siblingMonths.map((m) => (
                                <Link key={m.href} href={m.href} className={`px-4 py-3 rounded-2xl text-center font-black uppercase text-[11px] tracking-widest border bg-white ${siblingChipClass(m.verdict, false)}`}>
                                    <span className="block">{m.label}</span>
                                    <span className="block text-[8px] mt-1 opacity-80">{VERDICT_TAG[m.verdict]}</span>
                                </Link>
                            ))}
                            <div className={`px-4 py-3 rounded-2xl text-center font-black uppercase text-[11px] tracking-widest ${siblingChipClass(content.verdict, true)}`}>
                ...
                <section className="py-24 container mx-auto px-6">
                    <div className="text-center mb-14">
                        ...
                        <CharBlurIn text={`${dest.name.toUpperCase()} · ${content.monthLabel.toUpperCase()} FAQ`} className="text-2xl md:text-5xl font-black text-royal-blue uppercase tracking-tighter block leading-none" />
                    </div>
                ...
                <section className="py-28 container mx-auto px-6">
                    <div className="glass-card p-12 md:p-20 rounded-[4rem] bg-royal-blue text-white text-center shadow-2xl relative overflow-hidden">
                        ...
                        <h4 className="text-sunset-orange font-black uppercase tracking-[0.6em] text-xs mb-5">The {content.monthLabel} Mission</h4>
                        <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tighter leading-none mb-10 relative z-10">Architect <span className="text-sunset-orange">{dest.name}</span> in {content.monthLabel}</h2>
