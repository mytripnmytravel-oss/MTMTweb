            ...
            <main className="min-h-screen bg-white text-royal-blue overflow-hidden">
                ...
                <section className="relative h-[58vh] flex items-end overflow-hidden">
                    ...
                    <div className="container mx-auto px-6 relative z-10 pb-16">
                        ...
                        <h4 className="text-sunset-orange font-black uppercase tracking-[0.6em] text-xs mb-5">Inter-City Transfer</h4>
                    ...
                    <div className="max-w-5xl">
                        ...
                        <div className="flex flex-wrap gap-4 mt-12">
                            <div className="glass-card rounded-2xl px-7 py-4 border-royal-blue/5 flex items-center gap-3">
                                ...
                                <span className="font-black uppercase text-xs tracking-widest text-royal-blue">~{route.distanceKm} km</span>
                            </div>
                            <div className="glass-card rounded-2xl px-7 py-4 border-royal-blue/5 flex items-center gap-3">
                                <Clock className="text-sunset-orange" size={18} />
                                <span className="font-black uppercase text-xs tracking-widest text-royal-blue">~{route.driveHrs} hrs</span>
                            </div>
                            {route.via && (
                                <div className="glass-card rounded-2xl px-7 py-4 border-royal-blue/5 flex items-center gap-3">
                                    <span className="font-black uppercase text-xs tracking-widest text-royal-blue">via {route.via}</span>
                                </div>
                            )}
                        </div>
                    </div>
                ...
                <section className="py-20 container mx-auto px-6">
                    <h4 className="text-sunset-orange font-black uppercase tracking-[0.6em] text-xs mb-8">Vehicle Classes</h4>
                    <div className="grid sm:grid-cols-3 gap-5">
                        {content.vehicleClasses.map((v, i) => (
                            <div key={i} className="glass-card rounded-3xl p-7 border-royal-blue/5">
                                <div className="text-[10px] font-black uppercase tracking-[0.3em] text-sunset-orange mb-2">{v.tier} tier</div>
                                <div className="text-xl font-black text-royal-blue uppercase tracking-tighter mb-4">{v.name}</div>
                                <div className="space-y-2 text-[11px] font-black uppercase tracking-widest text-royal-blue/60">
                    ...
                    <div className="mt-8">
                        <Link href="/fleet" className="px-7 py-4 glass-card rounded-2xl border-royal-blue/10 font-black uppercase text-[11px] tracking-widest text-royal-blue hover:bg-sunset-orange hover:text-white transition-all duration-500 inline-flex items-center gap-3">Full Elite Fleet <ArrowRight size={14} /></Link>
                    </div>
                </section>
                ...
                <section className="py-24 bg-royal-blue/5">
                    <div className="container mx-auto px-6">
                        <div className="text-center mb-14">
                            ...
                            <CharBlurIn text={`${origin.name} → ${destination.name} FAQ`.toUpperCase()} className="text-2xl md:text-5xl font-black text-royal-blue uppercase tracking-tighter block leading-none" />
                        </div>
                ...
                <section className="py-20 container mx-auto px-6">
                    ...
                    <div className="flex flex-wrap gap-3">
                        <Link href={`/destinations/${origin.slug}`} className="px-6 py-3 glass-card rounded-2xl border-royal-blue/10 font-black uppercase text-[11px] tracking-widest text-royal-blue hover:bg-sunset-orange hover:text-white transition-all duration-500">Explore {origin.name}</Link>
                        <Link href={`/destinations/${destination.slug}`} className="px-6 py-3 glass-card rounded-2xl border-royal-blue/10 font-black uppercase text-[11px] tracking-widest text-royal-blue hover:bg-sunset-orange hover:text-white transition-all duration-500">Explore {destination.name}</Link>
                        <Link href={`/destinations/${destination.slug}/itinerary`} className="px-6 py-3 glass-card rounded-2xl border-royal-blue/10 font-black uppercase text-[11px] tracking-widest text-royal-blue hover:bg-sunset-orange hover:text-white transition-all duration-500">{destination.name} itineraries</Link>
                        <Link href="/services/inter-city" className="px-6 py-3 glass-card rounded-2xl border-royal-blue/10 font-black uppercase text-[11px] tracking-widest text-royal-blue hover:bg-sunset-orange hover:text-white transition-all duration-500 flex items-center gap-2">All inter-city routes <ArrowRight size={14} /></Link>
                    </div>
                </section>
                ...
                <section className="py-28 container mx-auto px-6">
                    <div className="glass-card p-12 md:p-20 rounded-[4rem] bg-royal-blue text-white text-center shadow-2xl relative overflow-hidden">
                        ...
                        <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tighter leading-none mb-10 relative z-10">{origin.name} → <span className="text-sunset-orange">{destination.name}</span></h2>
                        <Magnetic>
                            <Link href="/booking" className="inline-block relative z-10 bg-sunset-orange text-white py-6 px-12 rounded-[2rem] font-black uppercase tracking-widest text-sm hover:bg-white hover:text-royal-blue transition-all duration-500 shadow-xl">Book this Transfer</Link>
                        </Magnetic>
                    </div>
                </section>
