            ...
            <main className="min-h-screen bg-white text-royal-blue overflow-hidden">
                ...
                <section className="py-20 bg-royal-blue/5">
                    <div className="container mx-auto px-6">
                        ...
                        <div className="mt-10 flex flex-wrap gap-4">
                            <Link href={`/destinations/${dest.slug}`} className="px-7 py-4 glass-card rounded-2xl border-royal-blue/10 font-semibold uppercase text-[11px] tracking-widest text-royal-blue hover:bg-sunset-orange hover:text-white transition-all duration-500 flex items-center gap-3">
                ...
                <section className="py-24 container mx-auto px-6">
                    <div className="text-center mb-14">
                        ...
                        <CharBlurIn text={`${dest.name} ${lineName}`.toUpperCase()} className="text-2xl md:text-5xl font-semibold text-royal-blue uppercase tracking-tight block leading-none" />
                    </div>
